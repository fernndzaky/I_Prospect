...
<tbody>
  <tr>
    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
      <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;width:40%" alt="" data-proportionally-constrained="true" data-responsive="false" src="{{url('/assets/Logo.png')}}">
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center;"><span style="font-size: 43px">Forgotten your IProspect Timesheet Password?&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif">{{$password}}</span>
    </div>
  ...
  <tbody>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
            <div style="font-family: inherit; text-align: center">
            <span style="font-size: 18px">Disclaimer: Do not share your password with anyone, including the Timesheet admin. Click the button down below to log in to your account.</span> <br>
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{ route('login') }}" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;" target="_blank">Login</a>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
        <div>
          ...
          <span style="color: #000000; font-size: 18px; font-family: 'Roboto'"> <a href="{{ route('login') }}">{{ route('login') }}</a></span>
        </div>
      </td>
    </tr>
  </tbody>
