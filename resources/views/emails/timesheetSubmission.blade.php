...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Roboto', sans-serif; text-align: center;"><span style="font-size: 43px">A new timesheet has been submitted!&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Please click the button down below to review the submitted timesheet from <b>{{$user_name}}</b></span> <br>
    </div>
    <div></div></div></td>
  </tr>
</tbody>
          ...
          <tbody>
            <tr>
              <td align="center" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                  <a class="btnLogin" href="{{$timesheet_link}}" style="display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none;;font-family:Roboto" target="_blank">View Timesheet Detail</a>
              </td>
            </tr>
          </tbody>
        </table>
