...
<tbody>
  <tr>
    <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: 'Roboto', sans-serif; text-align: center;"><span style="font-size: 43px">Your timesheet has been {{$status}} by your supervisor.&nbsp;</span></div><div></div></div></td>
  </tr>
</tbody>
...
<tbody>
  <tr>
    ...
    <div>
        ...
        <span style="font-size: 18px">Please click the button down below to check your timesheet</span> <br>
    </div>
    <div></div></div></td>
  </tr>
</tbody>
